...
class NowStreamingMoviesPagingAdapter(private val click: (MovieModel) -> Unit) :
    PagingDataAdapter<MovieModel, NowStreamingMoviesPagingAdapter.MovieVH>(MovieDiffCallback()) {

    inner class MovieVH(private val binding: NowStreamingMovieItemBinding) :
